...
public class GoodReadsDeserializer {
    ...
    private static void deserializeSearch() {
    ...
    static Integer getNumberOfBookRead(final String response) {
        try {
    ...
    static List<GoodReadsBook> getBooksFromStringResponse(final String response) {
        final List<GoodReadsBook> books = newArrayList();
        ...
        try {
            ...
            elements.forEach(element -> {
                ...
                final GoodReadsBook goodReadsBook = new GoodReadsBook(Long.valueOf(id),
                        isbn,
                        title,
                        format,
                        getInteger(rating),
